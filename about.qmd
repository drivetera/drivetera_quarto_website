...
*Research Project* (Sep. 2024 – Present)  
- Developed an R package to streamline NetCDF file analysis, reducing workflow complexity.  
- Created 50+ tools for climate classification, climatology, and data visualization, preparing the package for CRAN publication.
